...
import com.edulink.courseservice.dto.AssignmentDto;
import com.edulink.courseservice.dto.LearningMaterialDto;
...
public class StudentController {
    ...
    public ResponseEntity<ApiResponse<List<LearningMaterialDto>>> getMaterials(@PathVariable String courseCode) {
    ...
    public ResponseEntity<ApiResponse<List<AssignmentDto>>> getAssignments(@PathVariable String courseCode) {
